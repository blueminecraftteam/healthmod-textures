...
- [first_aid_kit_back.png](first_aid_kit_back.png) / Text changed from "band" to "first"
- [first_aid_kit_bottom.png](first_aid_kit_bottom.png)
- [first_aid_kit_front.png](first_aid_kit_front.png) / Text changed from "band" to "first"
...
- [first_aid_kit_gui.png](first_aid_kit_gui.png)
- [bandage_box_gui.png](bandage_box_gui.png)
